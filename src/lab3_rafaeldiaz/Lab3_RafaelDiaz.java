        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    switch (resp) {
                        ...
                        case 5:
                            ...
                            if ((equipos.get(equip).getPresupuesto()) >= 0) {
                                ...
                                System.out.println("No tiene suficiente pisto para comprar");
                            }
                ...
                case 3:
                    ...
                    System.out.println("Que equipo desea organizar? 0,1,2...");
                    int orgequip = sc.nextInt();
                    if ((equipos.get(orgequip).getJugadores().size()) >= 11) {
                        System.out.println("Cuantos defensas desea tener");
                        int def = sc.nextInt();
